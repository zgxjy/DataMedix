# --- START OF FILE db_profiles/mimic_iv/panels/procedure_panel.py ---
...
class ProcedureConfigPanel(BaseSourceConfigPanel):
    ...
    def _get_primary_item_label_for_naming(self) -> Optional[str]:
        if self.item_list.selectedItems():
            return self.item_list.selectedItems()[0].text().split(' (ICD Code:')[0].strip()
        return None
    ...
    def _filter_items_action(self):
        ...
        dict_table, name_col, id_col = "mimiciv_hosp.d_icd_procedures", "long_title", "icd_code"
